...
a,b)};b.prototype.onZipped=function(){this.options.onZipped&&this.options.onZipped.call(this);location.href=this.fileEntry.toURL();this.options.onDone&&this.options.onDone.call(this)};b.prototype.onZippedBlob=function(a){this.options.onZipped&&this.options.onZipped.call(this);saveAs(a,this.options.zipFile);this.options.onDone&&this.options.onDone.call(this,link)};b.prototype.onCreatedFile=function(a){this.doTasks();this.fileEntry=a;this.fs.exportFileEntry(a,this.onZipped,this.onZipping,this.onError)};
b.prototype.onOpenedFile=function(a){a.remove(function(){a.filesystem.root.getFile(this.options.zipFile,{create:!0},this.onCreatedFile)}.bind(this),this.onError)};b.prototype.onRequestedFileSystem=function(a){a.root.getFile(this.options.zipFile,{create:!0},this.onOpenedFile)};b.prototype.onRequestedError=function(a){console.log(a);this.zipInMemory()};b.prototype.onRequestedQuota=function(a){g(TEMPORARY,a,this.onRequestedFileSystem,this.onRequestedError)};b.prototype.onDownloading=function(a,b){this.options.onProgress&&
this.options.onProgress.call(this,a,b,"download");this.options.onDownloading&&this.options.onDownloading.call(this,a,b)};b.prototype.onDownloaded=function(){this.options.onDownloaded&&this.options.onDownloaded.call(this);e?e.requestQuota(this.options.quota,this.onRequestedQuota,this.onRequestedError):this.zipInMemory()};b.prototype.zipInMemory=function(){this.doTasks();this.fs.exportBlob(this.onZippedBlob,this.onZipping,this.onError)};b.prototype.download=function(){var a=Object.keys(this.tasks);
preload({files:a,onProgress:this.onDownloading,onLoad:this.onDownloaded})};window.Zipacker=b})();
